...
If the question does not relate to the context, Don't answer it.

For example, let's say the context has nothing in it about tropical flowers;
then if I ask you about tropical flowers, just answer that context has no infomation about the topic
